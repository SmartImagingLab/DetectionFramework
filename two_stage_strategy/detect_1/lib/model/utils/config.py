...
__C.TRAIN.TRIM_HEIGHT = 256
# __C.TRAIN.TRIM_HEIGHT = 600
# __C.TRAIN.TRIM_WIDTH = 600
__C.TRAIN.TRIM_WIDTH = 256
...
# Iterations between snapshots快照
...
# __C.TRAIN.RPN_PRE_NMS_TOP_N = 1200
# Number of top scoring boxes to keep after applying NMS to RPN proposals
__C.TRAIN.RPN_POST_NMS_TOP_N = 2000
# __C.TRAIN.RPN_POST_NMS_TOP_N = 600
# Proposal height and width both need to be greater than RPN_MIN_SIZE (at orig image scale)
# RPN产生的region proposal最小的分辨率应该大于8*8（proposal的高和宽都应该大于RPN_MIN_SIZE，否则，映射到conv5上不足一个像素点）
...
__C.FPN_ANCHOR_SCALES = [1, 2, 4, 8, 16]      # changed by lwb
