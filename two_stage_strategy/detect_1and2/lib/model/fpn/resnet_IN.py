...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=100):       # 可改？
        self.inplanes = 16
...
class resnet(_FPN):
    # 修改：num_layers=101
    def __init__(self, classes, num_classes=2, pretrained=False, class_agnostic=False):
        ...
        _FPN.__init__(self, classes, num_classes, class_agnostic)
    ...
    def _init_modules(self):
        ...
        if self.class_agnostic:
            ...
            self.RCNN_bbox_pred = nn.Linear(256, 4 * 2)
