...
def parse_args():
    ...
    parser.add_argument('--dataset', dest='dataset',
                        ...
                        default='EP_detect', type=str)             # can alter
    ...
    parser.add_argument('--s', dest='session',
                        ...
                        default=162, type=int)                  # can alter
    ...
    parser.add_argument('--checkpoint', dest='checkpoint',
                        ...
                        default=2999, type=int)                 # can alter
    ...
    parser.add_argument('--thresh', dest='thresh',
                        ...
                        default=0.88, type=float)           # 置信度阈值 can alter
    parser.add_argument('--max_per_image', dest='max_per_image',
                        help='max number for one image',
                        default=100, type=int)             # 检测数量限制 can alter
...
if __name__ == '__main__':
    ...
    if args.dataset == "EP_detect":
        args.imdb_name = "traindata300-300-2"
        args.imdbval_name = "testdata300-300-2"
    ...
    for epoch in range(args.start_epoch, args.max_epochs):
        ...
        for i in range(num_images):
            ...
            if cfg.TEST.BBOX_REG:
                ...
                pred_boxes = bbox_transform_inv(boxes, box_deltas, 1)    # 综合前后预测的目标位置得到最后的位置预测
            ...
            # 遍历除背景外的所有类别，取出每个类别score > thresh( = 0.05)的所有框，NMS(阈值默认为0 .2)
            for j in range(1, imdb_test.num_classes):
                ...
                if inds.numel() > 0:
                    ...
                    if args.vis:
                        im2show = vis_detections(im2show, imdb_test.classes[j], cls_dets, 0.8)  # 可可视化！
        ...
        if mean_ap >= best_map:
            ...
            for key in recs.keys():
                ...
                plt.savefig('./output/visiual_map_loss/session{}_{}_PR.jpg'.format(args.session,key))
                plt.close()
        map.append(mean_ap)
    ...
    plt.savefig('./output/visiual_map_loss/session{}test_map.jpg'.format(args.session))
    plt.close()
    print("completed!!!")
